 ...
 ?>
	<form method="post" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'];?>' >
	  ...
	  <br />
	  <b class="color2"  style="visibility:hidden;"> Categories:</b><br />
	  <input class="form-control" name="categorie" type="text" value="Artist"  style="visibility:hidden;">
	  <br />
	  ...
	  <input type="text" value="<?php echo $from;?>" name="from" style="visibility:hidden;"/>
	   <input type="submit" class="btn btn-link color" value="Update Artist" name="okk"/>
   </form>
   <div id="preview">
