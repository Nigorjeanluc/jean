									...
									<table class="table table-condensed pcolor1">
										...
										<?php 
											...
											while(($myrow = mysql_fetch_array($pipsql))&&($count<1000))
											  ...
											  $link = 'lll='.$from.'&'.'fghcvdre='.$myrow['id'].'&gfhgdty='.'music'.'&index='.$count;
											     echo "<tr>";
												 ...
												 switch( $data)
												  ...
												  break;
													 case 1 : 									   
												  { echo '<td><b><a href="'.$mainMenu[$limit].'.php?'.$link.'">'.$myrow['artist']." - ".$myrow['name']."</a></b></td>" ; };
												  break;
												   case 2 : 									   
												  ...
												  echo "</tr>";
												  if(isset($_REQUEST['fghcvdre'])&&($count==$_REQUEST['index']))
												  break;
											     $count++;
											  }
											  ?>
